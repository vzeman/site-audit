...
def analyze(fetched: Iterable, extraction_rows: list[dict], analyzed_urls: set[str]) -> IndexabilityReport:
    ...
    for row in extraction_rows:
        ...
        normalized = {
            ...
            "meta_refresh_redirect": bool(row.get("meta_refresh_redirect")),
            "meta_refresh_target_url": row.get("meta_refresh_target_url", ""),
            "title_tag_count": int(row.get("title_tag_count") or 0),
            "meta_description_tag_count": int(row.get("meta_description_tag_count") or 0),
            ...
            "redirect_status_codes": list(row.get("redirect_status_codes") or []),
        ...
        for key in issue_keys:
            ...
            issues.append({
                ...
                "meta_refresh_redirect": normalized["meta_refresh_redirect"],
                "meta_refresh_target_url": normalized["meta_refresh_target_url"],
                "title_tag_count": normalized["title_tag_count"],
                "meta_description_tag_count": normalized["meta_description_tag_count"],
                ...
                "redirect_status_codes": list(normalized["redirect_status_codes"]),
